    ...
    var estrada = document.querySelector("div.estrada")
    ...
    estrada.style.top = "-28px"
    
    //testador imagem
    /*carro9.style.top = "370px"
    carro9.style.left = "168px"*/
    ...
    function road() {
      contadorRoad += speed / 2
     if(contadorRoad >= 0) {
        contadorRoad = -28
      }
      estrada.style.top = contadorRoad + "px"
    }
